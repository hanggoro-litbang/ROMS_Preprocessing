...
%     userpass = 'mariefariprahman%40gmail.com:AQWzsx123!' >> https://rda.ucar.edu/
...
% bbox = [117.5 125.5 -14.5 -8.5] % west east south north %
% bbox = [103.5 107.0 -8.0 -4.5] % sundaB_1km
% E = roms_get_era5_NCARds633_bulkflux(2021,06,bbox) >> per bulan

% userpass = [];
userpass = 'mariefariprahman%40gmail.com:AQWzsx123!'
fluxopt = 'allfluxes'; % onlyfluxes/bulkfluxes
