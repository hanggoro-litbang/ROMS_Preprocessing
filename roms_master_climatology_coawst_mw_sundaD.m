...
clc
clear all
diary('sundakopel_9km_log.txt')
time_mulai=datestr(now,'HH:MM:SS.FFF');
%%%%%%%%%%%%%%%%%%%%%   START OF USER INPUT  %%%%%%%%%%%%%%%%%%%%%%%%%%

% (1) Enter start date (T1) and number of days to get climatology data 
T1 = datenum(2022,12,28,00,0,0); %start date
...
%url = 'http://tds.hycom.org/thredds/dodsC/GLBa0.08/expt_90.9';     % Hindcast Data: 2011-01 to 2013-08
...
wdr = 'C:\Arief\ROMS\05_ICBC\03_SundaD_Kopel\9km';

% (4) Enter path and name of the ROMS grid
modelgrid = 'C:\Arief\ROMS\03_GridBuilder\01_Selat_Sunda\Kopel_Sunda3\grid_sundaD_9kmv3_kopel_batnas.nc';
...
time_selesai=datestr(now,'HH:MM:SS.FFF');
t11=datevec(datenum(time_mulai));
t22=datevec(datenum(time_selesai));
